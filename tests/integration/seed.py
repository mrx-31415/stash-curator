...
SEED_SCENES = [
    {
        ...
        "date": "2025-01-15",
        "tag_names": ["Baking", "Outdoor"],
        "performer_names": ["Test Performer One", "Test Performer Male"],
    },
    {
        "title": "Test Scene Chess Party",
        "details": "Two performers and a guest star.",
        "date": "2025-02-20",
        "tag_names": ["Chess", "Gardening"],
        "performer_names": ["Test Performer One", "Test Performer Two", "Test Performer Male"],
    },
    {
        "title": "Test Scene Cycling Stretch",
        "details": "Cycling performance.",
        "date": "2025-03-10",
        "tag_names": ["Cycling", "Cosplay"],
        "performer_names": ["Test Performer Two"],
    },
    {
        "title": "Test Scene Archery Adventure",
        "details": "Archery-focused scene.",
        "date": "2025-04-05",
        "tag_names": ["Archery", "Gardening", "Hiking"],
        "performer_names": ["Test Performer One"],
    },
    {
        "title": "Test Scene Knitting Encounter",
        "details": "Girl-on-girl action.",
        "date": "2025-05-18",
        "tag_names": ["Knitting", "Pottery"],
