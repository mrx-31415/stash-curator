...
CREATE TABLE model_lane_candidate_cache (
    model_id TEXT NOT NULL, lane TEXT NOT NULL CHECK (lane IN ('best_bets','revisit','discover','adventure')),
...
CREATE TABLE model_lane_order (
    model_id TEXT NOT NULL, lane TEXT NOT NULL CHECK (lane IN ('for_you','best_bets','revisit','discover','adventure')),
    ...
    source_lane TEXT NOT NULL CHECK (source_lane IN ('best_bets','revisit','discover','adventure')),
