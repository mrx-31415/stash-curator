...
CREATE TABLE model_lane_candidate_cache (
    model_id TEXT NOT NULL, lane TEXT NOT NULL CHECK (lane IN ('best_bets','revisit','stretch','blind_spots')),
...
CREATE TABLE model_lane_order (
    model_id TEXT NOT NULL, lane TEXT NOT NULL CHECK (lane IN ('for_you','best_bets','revisit','stretch','blind_spots')),
    ...
    source_lane TEXT NOT NULL CHECK (source_lane IN ('best_bets','revisit','stretch','blind_spots')),
